...
<body class="p-6 md:p-12 max-w-4xl mx-auto">
    ...
    <!-- LIMITI API - NUOVO BOX IMPORTANTE -->
    <div class="box border-yellow-600/50 bg-yellow-950/20">
         <div class="flex items-start gap-4">
            <div class="text-2xl">⚠️</div>
            <div>
                <h2 class="text-2xl font-bold text-white mb-2">Limiti Chiave Gratuita</h2>
                <p class="text-yellow-200/90 text-lg leading-relaxed">
                    Con una chiave API gratuita di Google, puoi generare circa <strong>2 o 3 corsi completi al giorno</strong>. 
                    <br>Se noti errori o blocchi durante la generazione (es. il caricamento si ferma), hai probabilmente raggiunto il limite giornaliero ("Quota Exceeded"). 
                    Dovrai attendere il giorno successivo per crearne altri.
                </p>
            </div>
        </div>
    </div>
